...
interface Location {
  branchName: string; // Changed from 'city' for clarity
  addressLine: string; // New field for the address/details
  mapEmbedUrl: string; // New field for the Google Maps iframe source
}

@Component({
  selector: 'app-network',
  standalone: true,
  // Pipes are added here to resolve compilation errors
